...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const NavRailHome(),
    );
  }

}

class NavRailHome extends StatefulWidget {
  const NavRailHome({super.key});

  @override
  State<NavRailHome> createState() => _NavRailHomeState();
}

class _NavRailHomeState extends State<NavRailHome> {
